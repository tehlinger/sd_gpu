...
\begin{figure}
    ...
    \hfill
    \subfloat[Puissance de calcul en fonction de la taille du bloc (en nombre d'éléments) avec et sanns mémoire partagée.
      \label{fig:K4_power}]{%
      \includegraphics[keepaspectratio,width=0.47\textwidth]{img/K4_K2.png}
    }
